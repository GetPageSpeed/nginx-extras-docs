...
| [nginx-module-access-control](modules/access-control.md)                 | Advanced access control based on variables                                    |
...
| [nginx-module-auth-hash](modules/auth-hash.md)                           | Secure link hash authentication                                               |
...
| [nginx-module-compression-normalize](modules/compression-normalize.md)   | NGINX Accept-Encoding Normalization module                                    |
| [nginx-module-compression-vary](modules/compression-vary.md)             | Enhanced Vary header handling for compression                                 |
...
| [nginx-module-delay](modules/delay.md)                                   | Delay requests for a given time                                               |
...
| [nginx-module-error-log-write](modules/error-log-write.md)               | Conditional error log entries in configuration                                |
...
| [nginx-module-internal-redirect](modules/internal-redirect.md)           | Internal redirect to a specified URI                                          |
| [nginx-module-ipscrub](modules/ipscrub.md)                               | IP address anonymizer module for NGINX                                        |
| [nginx-module-ipset-access](modules/ipset-access.md)                     | Zero-latency IP blocking using Linux kernel ipsets (v2)                       |
...
| [nginx-module-label](modules/label.md)                                   | Global key-value labels for dynamic configuration                             |
...
| [nginx-module-log-var-set](modules/log-var-set.md)                       | Set variables before access log writing                                       |
| [nginx-module-log-zmq](modules/log-zmq.md)                               | ZeroMQ logger module for NGINX                                                |
| [nginx-module-loop-detect](modules/loop-detect.md)                       | CDN-Loop header support for request loop prevention                           |
...
| [nginx-module-otel](modules/otel.md)                                     | NGINX OpenTelemetry dynamic module                                            |
...
| [nginx-module-request-cookies-filter](modules/request-cookies-filter.md) | Fine-grained request cookies control                                          |
| [nginx-module-rewrite-status](modules/rewrite-status.md)                 | Rewrite response status codes                                                 |
...
| [nginx-module-selective-cache-purge](modules/selective-cache-purge.md)   | Nginx module for the key-value store                                          |
| [nginx-module-server-redirect](modules/server-redirect.md)               | Redirect server name within the same request                                  |
...
| [nginx-module-unzstd](modules/unzstd.md)                                 | Decompresses Zstd-encoded responses for clients that do not support it        |
...
| [nginx-module-upstream-log](modules/upstream-log.md)                     | Writes upstream request logs in a specified format                            |
| [nginx-module-upsync](modules/upsync.md)                                 | NGINX module for syncing upstreams from consul or etcd                        |
| [nginx-module-var](modules/var.md)                                       | Dynamic variable assignment through predefined functions                      |
