...
title: "JWT verification library for nginx-module-lua with JWKS integration"
description: "RPM package lua-resty-jwt-verification: JWT verification library for nginx-module-lua with JWKS integration"

---
  
# *jwt-verification*: JWT verification library for nginx-module-lua with JWKS integration
...
This document describes lua-resty-jwt-verification [v0.7.0](https://github.com/anvouk/lua-resty-jwt-verification/releases/tag/v0.7.0){target=_blank} 
...
nginx-module-jwt-verification](https://github.com/anvouk/lua-resty-jwt-verification){target=_blank}.