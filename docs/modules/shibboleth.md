...
shib<span id="request">request</span> \<uri\>[\|off \|](##SUBST##|off
...
shib<span id="request_set">request_set</span> \<variable\> \<value\>  
**Context:** `http`, `server`, `location`  
**Default:** `none`
...
shib<span id="request_use_headers">request_use_headers</span> on[\|off \|](##SUBST##|off
   |) **Context:** `http`, `server`, `location`  
**Default:** `off`
