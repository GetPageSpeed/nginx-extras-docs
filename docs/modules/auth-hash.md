...
title: "Secure link hash authentication"
description: "RPM package nginx-module-auth-hash. The auth hash module provides secure link hash authentication for NGINX. It validates URLs with cryptographic hashes to protect content from unauthorized access, similar to nginx's built-in secure_link but with additional flexibility."

---

# *auth-hash*: Secure link hash authentication
...
This document describes nginx-module-auth-hash [v0.1.0](https://github.com/dvershinin/ngx_http_auth_hash_module/releases/tag/0.1.0){target=_blank} 
...
repository for 
nginx-module-auth-hash](https://github.com/dvershinin/ngx_http_auth_hash_module){target=_blank}.