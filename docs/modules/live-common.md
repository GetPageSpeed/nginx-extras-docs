...
This document describes nginx-module-live-common [v2.0.1](https://github.com/kaltura/media-framework/releases/tag/v2.0.1){target=_blank} 
released on Oct 05 2025.
