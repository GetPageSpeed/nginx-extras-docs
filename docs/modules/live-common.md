...
This document describes nginx-module-live-common [v2.0.0](https://github.com/kaltura/media-framework/releases/tag/v2.0.0){target=_blank} 
released on Sep 14 2025.
