...
### auth<span id="digest">digest</span>
...
### auth<span id="digest_user_file">digest_user_file</span>
...
### auth<span id="digest_timeout">digest_timeout</span>
...
### auth<span id="digest_expires">digest_expires</span>
...
### auth<span id="digest_replays">digest_replays</span>
...
usage and the shm<span id="size">size</span> may have to be adjusted to
keep up with heavy traffic within the digest-protected location blocks.

### auth<span id="digest_evasion_time">digest_evasion_time</span>
...
### auth<span id="digest_maxtries">digest_maxtries</span>
...
### auth<span id="digest_shm_size">digest_shm_size</span>
