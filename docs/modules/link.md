...
This document describes nginx-module-link [v3.2.4](https://github.com/Taymindis/nginx-link-function/releases/tag/3.2.4){target=_blank} 
...
repository for 
nginx-module-link](https://github.com/Taymindis/nginx-link-function){target=_blank}.